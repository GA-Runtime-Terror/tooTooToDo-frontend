...
console.log(props.user)
  ...
  const handleSubmit = ((id) => {
    fetch(`https://toucan-do-it.herokuapp.com/lists/${props.user.toDoList}` , {method: 'POST',
    headers: {
  ...
  const handleRemove = ((id) => {
    fetch(`https://toucan-do-it.herokuapp.com/lists/${props.user.toDoList}/${id}` , {method: 'DELETE'})
    .then((res) => res.json())
...
if (list) task = list.map ((item) => {
    return <li className='listItem-form'>
